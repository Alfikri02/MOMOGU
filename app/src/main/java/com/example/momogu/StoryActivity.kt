...
import com.example.momogu.Model.StoryModel
import com.example.momogu.Model.UserModel
import com.example.momogu.databinding.ActivityStoryBinding
    ...
    private fun seenNumber(storyId: String) {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                binding.seenNumber.text =
                    getString(R.string.STORY_ACTIVITY_LBL_SEEN_NUMBER, p0.childrenCount.toString())
            }
    ...
    private fun getStories(userId: String) {
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                Picasso.get().load(imageList?.get(counter)).placeholder(R.color.blackColor)
